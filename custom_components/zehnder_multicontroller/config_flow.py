"""Adds config flow for Zehnder Multicontroller."""
...
class ZehnderMulticontrollerFlowHandler(ConfigFlow, domain=DOMAIN):
    """Handle a config flow for Zehnder Multicontroller."""
