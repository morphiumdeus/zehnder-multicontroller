...
| `sensor`        | Sensor entities for temperature, humidity and values.     |
...
1. Click install.
1. In the HA UI go to "Configuration" -> "Integrations" click "+" and search for "Zehnder Multicontroller".
...
[license]: https://github.com/morphiumdeus/zehnder-multicontroller/blob/main/LICENSE
